...
The `monty` environment `MontyREPL` runs code through [pydantic-monty](https://pypi.org/project/pydantic-monty/), which provides stronger sandboxing constraints than `local`. Install it with:
```bash
